...
extern "C" {
    ...
    Java_com_reveny_emulator_detection_EmulatorDetection_isDetected(JNIEnv *env, jobject clazz) {
        checkHardware();
        checkMounts();
        checkModules();
        checkCPU();
    ...
    Java_com_reveny_emulator_detection_EmulatorDetection_getResult(JNIEnv *env, jobject clazz) {
